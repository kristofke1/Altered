...
type: location
category: vehicle
source: ["faction_ordis", "[[T42_the_deep_tumult]]"]
parent_location:
sub_locations: []
population:
area:
founded:
status: repairs nearly complete
controlling_faction:
present_factions:
  - "[[Ordis]]"
government_type:
notable_features:
  - Day Barque
  - Edged profile
  - Sky-cruising flagship
  - Armed with Alterers and Tagmata troops
  - Currently undergoing repairs in Sadracca
  - To join Rediscovery Endeavor
climate:
characters: []
tags:
  - ship
...
## Overview
Mandjet, also known as the Day Barque, is one of two magnificent flagship vessels with edged profiles that cruised the [[Asgartha|Asgarthan]] Protectorate. It serves as a mobile defense platform for the [[Ordis]] faction.
